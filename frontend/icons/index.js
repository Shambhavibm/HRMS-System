...
import { ReactComponent as LoaderIcon } from "./loader-icon.svg?react";
import { ReactComponent as LinkIcon } from "./link-icon.svg?react";
import { ReactComponent as UploadCloudIcon } from "./upload-cloud-icon.svg?react";
import { ReactComponent as XCircleIcon } from "./x-circle.svg?react";
import { ReactComponent as AssetITIcon } from "./asset-it-inventory.svg?react";
import { ReactComponent as ShoppingBagIcon } from "./shopping-bag.svg?react";
import { ReactComponent as UserRemoveIcon } from "./delete-user.svg?react";
import { ReactComponent as XMarkIcon } from "./xmark-icon.svg?react";
import { ReactComponent as CheckBadgeIcon } from "./check-badge-icon.svg?react";
import { ReactComponent as LocationMarkerIcon } from "./location-marker-icon.svg?react";
